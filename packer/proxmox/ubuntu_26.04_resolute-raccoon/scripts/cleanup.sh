...
# Cleaning history
# history -c && history -w
# It brings error: `proxmox-iso.ubuntu: /tmp/script_6353.sh: line 35: history: HISTFILE: parameter null or not set`
# Probably due to HISTFILE environment variable not defined.
