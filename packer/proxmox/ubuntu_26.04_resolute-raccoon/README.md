...
Date: 09.07.2026  
Proxmox VE: 9.1.14  
Packer host's operating system: Windows 11 25H2 (26200.8655)  
Packer Version: v1.15.4
Packer Proxmox Plugin: packer-plugin-proxmox_v1.2.3_x5.0_windows_amd64.exe
...
Check `ubuntu-26.04.pkr.hcl` file. It provides detailed fix for Packer .HTTPIP Issue.
Use `Get-NetAdapter | ft -AutoSize` to find the correct name of network adapter you should use
in `http_interface` directive in `ubuntu-26.04.pkr.hcl`.