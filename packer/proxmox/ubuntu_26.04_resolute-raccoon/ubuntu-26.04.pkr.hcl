# Packer Template: Ubuntu 26.04 LTS (Resolute Raccoon) vSphere template.
# Author: ahpooch
...
# Variables values should be set in './ubuntu-26.04.auto.pkrvars.hcl' and './credentials.auto.pkrvars.hcl' files.
...
source "proxmox-iso" "ubuntu" {
  ...
  ##################################################################################################################################################
  http_interface          = "vEthernet (External Ahpooch Switch)" #"Ethernet"
